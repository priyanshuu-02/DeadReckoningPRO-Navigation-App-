...
public class GraphActivity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if (counterSensitivity != null && !counterSensitivity.equals("default"))
        ...
        Toast.makeText(GraphActivity.this, getString(R.string.stride_length_m_format, String.valueOf(strideLength)), Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode){
            case 0:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(GraphActivity.this, R.string.permission_thanks, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(GraphActivity.this, R.string.location_perm_required_tour, Toast.LENGTH_LONG).show();
                    finish();
                }
                break;
        }
